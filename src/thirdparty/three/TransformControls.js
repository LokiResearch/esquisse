...
class TransformControlsGizmo extends Object3D {
  ...
  constructor() {
    ...
    const sphereGeometry = new SphereGeometry(0.02, 10, 10);
    ...
    const gizmoTranslate = {
      origin: [
        [new Mesh(sphereGeometry, matYellow), [0, 0, 0], [0, 0, 0]],
      ],
      X: [
      ...
      Y: [
        [new Mesh(arrowGeometry, matGreen), [0, 1, 0], [0, 0, 0], null, 'fwd'],
        [new Mesh(arrowGeometry, matGreen), [0, 1, 0], [0, 0, 0], null, 'bwd'],
    ...
    const helperTranslate = {
      START_X: [
        [new Mesh(new OctahedronGeometry(0.01, 2), matRed), null, null, null, 'helper']
      ],
      START_Y: [
        [new Mesh(new OctahedronGeometry(0.01, 2), matGreen), null, null, null, 'helper']
      ],
      START_Z: [
        [new Mesh(new OctahedronGeometry(0.01, 2), matBlue), null, null, null, 'helper']
      ],
      END: [
      ...
      DELTA_X: [
        [new Line(TranslateHelperGeometry(), matLineRed), null, null, null, 'helper']
      ],
      DELTA_Y: [
        [new Line(TranslateHelperGeometry(), matLineGreen), null, null, null, 'helper']
      ],
      DELTA_Z: [
        [new Line(TranslateHelperGeometry(), matLineBlue), null, null, null, 'helper']
      ],
    };
  ...
  updateMatrixWorld(force) {
    ...
    for (let i = 0; i < handles.length; i ++) {
      ...
      if (handle.tag === 'helper') {
        ...
        } else if (handle.name === 'START_X') {

          handle.position.copy(this.worldPositionStart);
          handle.visible = this.dragging;

        } else if (handle.name === 'START_Y') {

          handle.position.copy(this.worldPositionStart);
          handle.visible = this.dragging;

        } else if (handle.name === 'START_Z') {
